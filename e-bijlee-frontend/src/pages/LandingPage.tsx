    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-blue-100 flex flex-col items-center justify-center">
      <div className="text-center">
        ...
        <div className="mt-8 flex gap-6 justify-center">
          <a
            href="/register"
            className="px-8 py-3 bg-blue-600 text-white rounded-lg text-lg font-medium hover:bg-blue-700 shadow-md transition"
          >
            Register
          </a>
          <a
            href="/login"
            className="px-8 py-3 bg-orange-500 text-white rounded-lg text-lg font-medium hover:bg-orange-600 shadow-md transition"
          >
            Login
          </a>
        </div>
